...
while running:
    ...
    score_text=font.render(f"Score:{bot.score}")
    score_rect=score_text.get_rect(centerx=500,top=60)
    lives_text=font.render(f"Lives:{bot.lives}")
    ...
    if bot.score >=10:
        ...
        print("You Win!")
        running=False
    pygame.draw.line(screen,"black",50,0,1000,800)
